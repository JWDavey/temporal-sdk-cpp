...
async_::Task<WorkflowListPage> ClientOutboundInterceptor::list_workflows(
    ListWorkflowsInput input) {
    co_return co_await next().list_workflows(std::move(input));
}

async_::Task<WorkflowListPage>
...
async_::Task<WorkflowExecutionCount>
